      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header" style="vertical-align: middle;">
            <h3 class="card-title" style="line-height: 40px;" >Data Surat Nikah</h3>

            <div class="card-tools" style="" >
              <a href="<?php echo site_url('nikah/add') ?>" class="btn btn-primary">Tambah Data</a>
            </div>
          </div>
          <!-- /.card-header -->
...
<script>
  ...
  $(document).ready(function() {
    tabel=$('#tableDaftar').DataTable({
      "ajax": {
        url : "<?php echo site_url("nikah/getAll")?>",
        type : 'GET'
      }
    });
  });
