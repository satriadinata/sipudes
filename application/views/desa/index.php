      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header" style="vertical-align: middle;">
            <h3 class="card-title" style="line-height: 40px;" >Data Akun Desa</h3>

            <div class="card-tools" style="" >
              <a href="<?php echo site_url('desa/add') ?>" class="btn btn-primary">Tambah Data</a>
...
<script>
  ...
  $(document).ready(function() {
    tabel=$('#tableDaftar').DataTable({
      "ajax": {
        url : "<?php echo site_url("desa/getAll")?>",
        type : 'GET'
      }
    });
  });
  function edit(id){
    ...
    $.ajax({
      url: "<?php echo site_url('desa/edit') ?>",
      type:'post',
      data:data,
