      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header" style="vertical-align: middle;">
            <h3 class="card-title" style="line-height: 40px;" >Data Akun RT/RW</h3>

            <div class="card-tools" style="" >
              <a href="<?php echo site_url('akun/add') ?>" class="btn btn-primary">Tambah Data</a>
...
<script>
  ...
  $(document).ready(function() {
    tabel=$('#tableDaftar').DataTable({
      "ajax": {
        url : "<?php echo site_url("akun/getAll")?>",
        type : 'GET'
      }
    });
  });
  function edit(id){
    ...
    $.ajax({
      url: "<?php echo site_url('akun/edit') ?>",
      type:'post',
      data:data,
  ...
  function hapus(id){
    ...
    if (confirm) {
      ...
      $.ajax({
        url: "<?php echo site_url('akun/hapus') ?>",
        type:'post',
        data:data,
        beforeSend:function(){
