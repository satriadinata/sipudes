        ...
        <div class="card">
          <div class="card-header" style="vertical-align: middle;">
            ...
            <div class="card-tools" style="" >
              <a href="<?php echo site_url('akun_kepdes/add') ?>" class="btn btn-primary">Tambah Data</a>
            </div>
          </div>
          <!-- /.card-header -->
...
<script>
  ...
  $(document).ready(function() {
    tabel=$('#tableDaftar').DataTable({
      "ajax": {
        url : "<?php echo site_url("akun_kepdes/getAll")?>",
        type : 'GET'
      }
    });
  });
  function edit(id){
    ...
    $.ajax({
      url: "<?php echo site_url('akun_kepdes/edit') ?>",
      type:'post',
      data:data,
  ...
  function hapus(id){
    ...
    if (confirm) {
      ...
      $.ajax({
        url: "<?php echo site_url('akun_kepdes/hapus') ?>",
        type:'post',
        data:data,
        beforeSend:function(){
