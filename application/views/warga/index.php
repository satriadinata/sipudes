      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header" style="vertical-align: middle;">
            <h3 class="card-title" style="line-height: 40px;" >Data Warga</h3>

            <div class="card-tools" style="" >
              <a href="<?php echo site_url('warga/add') ?>" class="btn btn-primary">Tambah Data</a>
              ...
              <a href="<?php echo site_url('warga/export') ?>" class="btn btn-primary">Export Excell</a>
            </div>
          </div>
          <!-- /.card-header -->
...
<script>
  ...
  $(document).ready(function() {
    tabel=$('#tableDaftar').DataTable({
      "ajax": {
        url : "<?php echo site_url("warga/getAll")?>",
        type : 'GET'
      }
    });
  });
  ...
  function hapus(id){
    ...
    if (confirm) {
      ...
      $.ajax({
        url: "<?php echo site_url('warga/hapus') ?>",
        type:'post',
        data:data,
        beforeSend:function(){
