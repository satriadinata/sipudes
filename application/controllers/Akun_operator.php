...
class Akun_operator extends CI_Controller {
	...
	public function add()
	{
		...
		$this->load->view('akun_operator/add',$data);
	}
	public function post()
	{
		...
		redirect(site_url('akun_operator'));
	}
	public function getAll()
	{
		...
		$wargas = $this->Akun_model->get_operator($kode_desa);
	...
	public function edit()
	{
		...
		$this->load->view('akun_operator/edit', $data);
	}
